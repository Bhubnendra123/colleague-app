 ...
 */
public class ColleagueDetailsActivity extends Activity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Skeleton.isDetailView = false;
        //skeleton.setImageBitmap(null);
    }

    private void setData(final Colleague colleague, Bitmap image) {
        ...
        if(!colleague.getLineManager().equals("")) {
            ...
            lineManager.setClickable(true);
            Linkify.addLinks(lineManager  , Linkify.ALL);
            lineManager.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new RetrieveDataTask().execute(colleague.getLineManagerLink());
            ...
            Snackbar.make(mLayout, R.string.permission_call_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat.requestPermissions(ColleagueDetailsActivity.this,
    ...
    private class RetrieveDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Colleague colleague = skeleton.getColleagueDetails(s);
            Intent intent = new Intent(ColleagueDetailsActivity.this, ColleagueManagerDetailsActivity.class);
    ...
    private String downloadUrl(String urlString) throws IOException, JSONException {
        ...
        gdHttpClient.getCredentialsProvider().setCredentials(AuthScope.ANY, new NTCredentials(username, password, getHostname(), domain));
